...
public class CountryDao extends JdbcDaoSupport {
	...
	private static final String UPDATE_COUNTRY_NAME_TEMPLATE =
			"update country SET name = '%s' where code_name = '%s'";
	...
	public void updateCountryName(String codeName, String newCountryName) {
		getJdbcTemplate()
				.execute(String.format(UPDATE_COUNTRY_NAME_TEMPLATE, newCountryName, codeName));
	}
